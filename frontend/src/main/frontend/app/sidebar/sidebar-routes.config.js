...
exports.ROUTES = [
    ...
    { path: 'table', title: 'Mushroom List', menuType: sidebar_metadata_1.MenuType.LEFT, icon: 'material-icons' },
    ...
    { path: 'maps', title: 'Map of Mushrooms', menuType: sidebar_metadata_1.MenuType.LEFT, icon: 'material-icons' },
